...
const EmbeddingsView = dynamic(() => import("../../components/EmbeddingsView"), {
    ssr: false,
    loading: () => (
        <div className="rounded-2xl border border-border-secondary bg-gray-50/50 px-6 py-16 text-center text-sm text-foreground-muted">
...
export default function AdCategoryDetailPage() {
        ...
        return (
            <div className="min-h-screen bg-white">
                <header className="border-b border-border-secondary px-8 py-6">
                    <Link href="/ad-inventory" className="text-sm text-foreground-muted hover:text-foreground-body transition-colors mb-2 inline-flex items-center gap-1">
                    ...
                    <h1 className="text-[32px] font-bold tracking-[-1.5px] text-foreground-body mt-2">Category Not Found</h1>
                </header>
                <div className="px-8 py-12 text-center">
                    <p className="text-sm text-foreground-muted">This ad category doesn&apos;t exist.</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-white">
            {/* ── Header ─────────────────────────────────────────── */}
            <header className="border-b border-border-secondary px-8 pt-6">
                <div className="flex items-start justify-between pb-6">
                    <div>
                        ...
                        <h1 className="text-[32px] font-bold tracking-[-1.5px] text-foreground-body mt-2">{data.category}</h1>
                        <div className="flex items-center gap-2 mt-2 flex-wrap">
                            {data.brands.map((brand) => (
                                <span key={brand} className="px-2.5 py-0.5 rounded-full bg-gray-50 text-[11px] font-medium text-foreground-subtle">
                                    {brand}
                                </span>
                            ))}
                        </div>
                    ...
                    <div className="flex items-center gap-4 shrink-0 mt-2">
                        <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-50 text-foreground-subtle">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 rounded-xl border border-border-secondary text-sm font-medium text-foreground-body hover:border-border-primary hover:bg-gray-50 transition-all duration-200"
                        >
                            <svg viewBox="0 0 12 12" fill="none" className="w-3.5 h-3.5">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 rounded-xl border border-border-secondary text-sm font-medium text-foreground-body hover:border-border-primary hover:bg-gray-50 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <div className="flex items-center gap-6">
                    <button
                        ...
                        className={`text-sm font-semibold transition-colors flex items-center gap-2 cursor-pointer ${activeTab === "videos" ? "text-tl-master-brand-dark-green border-b-2 border-tl-master-brand-dark-green pb-3 -mb-[1px]" : "text-foreground-muted hover:text-foreground-body pb-3 -mb-[1px]"}`}
                    >
                    ...
                    <button
                        ...
                        className={`text-sm font-semibold transition-colors flex items-center gap-2 cursor-pointer ${activeTab === "embeddings" ? "text-tl-master-brand-dark-green border-b-2 border-tl-master-brand-dark-green pb-3 -mb-[1px]" : "text-foreground-muted hover:text-foreground-body pb-3 -mb-[1px]"}`}
                    >
            ...
            {warmCacheSummary && (
                <div className="px-8 pt-4">
                    <p className="text-xs text-foreground-subtle rounded-lg border border-border-secondary bg-gray-50/80 px-4 py-2">
                        {warmCacheSummary}
                    </p>
                </div>
            )}
            ...
            <div className="px-8 py-6 space-y-8">
                ...
                {activeTab === "videos" && (
                    <>
                        ...
                        <div className="bg-white border border-border-secondary rounded-2xl overflow-hidden shadow-sm">
                            <div className="px-6 py-4 border-b border-border-secondary bg-gray-50/50 flex items-center justify-between">
                                <div>
                                    <h2 className="text-sm font-bold text-foreground-body">Targeting &amp; Brand Safety Rules</h2>
                                    <p className="text-xs text-foreground-muted mt-0.5">Edit the base rules for this category. These configure the AI recommendations.</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-border-light">
                                ...
                                <div className="p-6">
                                    <div className="flex items-center justify-between mb-2">
                                        <h3 className="text-[11px] font-semibold uppercase tracking-[1.5px] text-tl-master-brand-dark-green flex items-center gap-1.5">
                                        ...
                                        {!addingContext && (
                                            <button
                                                ...
                                                className="text-[10px] font-semibold text-foreground-muted hover:text-foreground-body transition-colors flex items-center gap-1 cursor-pointer"
                                            >
                                    ...
                                    <div className="flex items-center gap-2 flex-wrap">
                                        {data.targetContexts.map((ctx) => (
                                            <span key={ctx} className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full bg-tl-master-brand-light-green border border-tl-master-brand-light-green text-[11px] font-medium text-tl-master-brand-dark-green group/tag transition-all duration-200">
                                                {ctx}
                                                <button onClick={() => removeContext(ctx)} className="w-0 overflow-hidden opacity-0 group-hover/tag:w-3.5 group-hover/tag:ml-1 group-hover/tag:opacity-100 transition-all duration-200 hover:text-foreground-body shrink-0 cursor-pointer">
                                    ...
                                    {addingContext && (
                                        <div className="mt-4 p-3 bg-gray-50 rounded-lg border border-border-secondary">
                                            <div className="flex items-center gap-2">
                                                <input
                                                    ...
                                                    className="flex-1 px-3 py-2 rounded border border-border-primary bg-white text-xs text-foreground-body placeholder:text-foreground-muted focus:outline-none focus:border-tl-master-brand-dark-green transition-colors"
                                                />
                                                <button onClick={() => { setAddingContext(false); setContextInput(""); }} className="text-xs font-medium text-foreground-muted hover:text-foreground-body transition-colors cursor-pointer">Cancel</button>
                                            </div>
                                            {unusedContextSuggestions.length > 0 && (
                                                <div className="flex flex-wrap gap-1.5 mt-2.5">
                                                    {unusedContextSuggestions.map((s) => (
                                                        <button key={s} onClick={() => addContext(s)} className="px-2 py-1 rounded border border-border-secondary bg-white text-[10px] font-medium text-foreground-subtle hover:bg-gray-50 hover:text-foreground-body transition-colors cursor-pointer shadow-sm">
                                                            + {s}
                                                        </button>
                                                    ))}
                                                </div>
                                ...
                                <div className="p-6">
                                    <div className="flex items-center justify-between mb-2">
                                        <h3 className="text-[11px] font-semibold uppercase tracking-[1.5px] text-tl-master-brand-dark-pink flex items-center gap-1.5">
                                    ...
                                    <div className="flex items-center gap-2 flex-wrap">
                                        {data.exclusions.map((exc) => (
                                            <span key={exc} className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full bg-tl-master-brand-light-pink border border-tl-master-brand-light-pink text-[11px] font-medium text-tl-master-brand-dark-pink group/tag transition-all duration-200">
                                                {exc}
                                                <button onClick={() => removeExclusion(exc)} className="w-0 overflow-hidden opacity-0 group-hover/tag:w-3.5 group-hover/tag:ml-1 group-hover/tag:opacity-100 transition-all duration-200 hover:text-foreground-body shrink-0 cursor-pointer">
                                                    <svg viewBox="0 0 8 8" fill="none" className="w-2.5 h-2.5"><path d="M6 2L2 6M2 2L6 6" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" /></svg>
                                                </button>
                                            </span>
                                        ))}
                                        ...
                                        <div className="mt-4 p-3 bg-gray-50 rounded-lg border border-border-secondary">
                                            <div className="flex items-center gap-2">
                                                <input
                                                    ...
                                                    className="flex-1 px-3 py-2 rounded border border-border-primary bg-white text-xs text-foreground-body placeholder:text-foreground-muted focus:outline-none focus:border-tl-master-brand-dark-pink transition-colors"
                                                />
                                                <button onClick={() => { setAddingExclusion(false); setExclusionInput(""); }} className="text-xs font-medium text-foreground-muted hover:text-foreground-body transition-colors cursor-pointer">Cancel</button>
                                            </div>
                                            {unusedExclusionSuggestions.length > 0 && (
                                                <div className="flex flex-wrap gap-1.5 mt-2.5">
                                                    {unusedExclusionSuggestions.map((s) => (
                                                        <button key={s} onClick={() => addExclusion(s)} className="px-2 py-1 rounded border border-border-secondary bg-white text-[10px] font-medium text-foreground-subtle hover:bg-gray-50 hover:text-foreground-body transition-colors cursor-pointer shadow-sm">
                                                            + {s}
                                                        </button>
                                                    ))}
                                                </div>
                            ...
                            {videosLoading ? (
                                ...
                                <div className="flex flex-col items-center justify-center py-16 rounded-2xl border border-border-secondary">
                                    <div className="w-12 h-12 rounded-full bg-gray-50 flex items-center justify-center mb-4">
                                        <svg viewBox="0 0 12 12" fill="none" className="w-5 h-5 text-foreground-muted">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M5.55217 4.79058V7.20942L7.26522 6L5.55217 4.79058ZM4.5 4.315C4.5 3.65679 5.23462 3.27103 5.76926 3.64849L8.15593 5.33348C8.61469 5.65737 8.61469 6.34263 8.15593 6.66652L5.76926 8.35151C5.23462 8.72897 4.5 8.34321 4.5 7.685V4.315Z" fill="currentColor" />
                                        </svg>
                                    </div>
